 ...
 */
 const QUESTION_SET = [
  ...
  },
  {
    id: "q2",
    type: "choice",
    prompt: "While wandering through the forest, you happen upon a bear! What do are you most likely to do?",
    answers: [
      {
...
const ARCHETYPES = {
  ...
  "+-+-": { name: "The Control Freak",        image: "+-+-.png", desc: "You've dedicated your life for mathematics, and bringing down your arch nemesis, the Evil Twink." },
